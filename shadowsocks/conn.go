...
func DialWithRawAddr(rawaddr []byte, server string, cipher *Cipher, obfs *Obfs) (c *Conn, err error) {
...
func Dial(addr, server string, cipher *Cipher, obfs *Obfs) (c *Conn, err error) {
	ra, err := RawAddr(addr)
	if err != nil {
		return
	}
